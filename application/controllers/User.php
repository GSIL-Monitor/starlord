    ...
    public function config()
    {
        ...
        $config = array(
            ...
            'docoment' => array(
                ...
                'notice_list' => array(
                    '以下列表中的群和你的拼车群一一对应',
                    '转发行程到拼车群后，不要忘记点击你的分享，将行程加入拼车群管家',
                ),                //拼车群tab上的公告
                'group_page_info' => '在拼车群分享并点击本小程序，该群所有行程将汇总管理到以上列表',
                'adopt' => '如果您是本群群主，请加客服（wx号：pinchequnguanjia）,成为该群管理员；<br />ps：群主同意的情况下，其他成员也可以担任管理员。<br />管理员福利：发布公告，置顶群内行程，wx群拉新~更多功能开发中',        //没有群主的群的认领文案
                'faq' => '关于<br />我们',                //没有拼车群的时候展现的使用说明，同时也是”我的“中”关于我们“的内容
                ...
                'contact' => '客服<br />wx号：pinchequnguanjia',        //联系客服页的内容
